if !exists("g:vscode") 
	...
	if has('nvim-0.4.0') || has('patch-8.2.0750')
	  ...
	  nnoremap <silent><nowait><expr> <C-Right> coc#float#has_scroll() ? coc#float#scroll(1) : "\<C-Right>"
	  nnoremap <silent><nowait><expr> <C-Left> coc#float#has_scroll() ? coc#float#scroll(0) : "\<C-Left>"
	  inoremap <silent><nowait><expr> <C-Right> coc#float#has_scroll() ? "\<c-r>=coc#float#scroll(1)\<cr>" : "\<C-Right>"
	  inoremap <silent><nowait><expr> <C-Left> coc#float#has_scroll() ? "\<c-r>=coc#float#scroll(0)\<cr>" : "\<C-Left>"
